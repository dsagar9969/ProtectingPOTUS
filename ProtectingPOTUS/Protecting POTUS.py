...
bk = Image("gameimages\\whitehouse.gif",game)
bk.resizeTo(game.width,game.height)
game.setBackground(bk)


obama = Image("gameimages\\obama.gif", game)
obama.setSpeed(4,60)
...
for times in range(50):
    cops.append( Image("gameimages\\cop.png", game) )
...
trump = Image("gameimages\\trump.gif",game)
trump.resizeBy(-25)

explosion = Animation("gameimages\\explosion.png",22,game, 285/5, 320/5)
explosion.visible = False
brick = Image("gameimages\\brick.png", game)
brick.resizeBy(-90)
brick.visible = False
...
shoot = Sound("gamesounds\\blaster.wav",1)
boom = Sound("gamesounds\\Arcade Explo A.wav",3)
